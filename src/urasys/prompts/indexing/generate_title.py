...
# TASK: Title or Quick Description Generation
...
Expected Output:
{{
    "title_or_quick_description": "Neil Armstrong: The First Person to Walk on the Moon and His Contributions to Aerospace Exploration."
}}
