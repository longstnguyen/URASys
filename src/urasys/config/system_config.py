...
class Settings:
    ...
    def __init__(self):
        ...
        # Storage mode: "local" (Milvus Lite on disk) or "cloud" (Zilliz Cloud)
        self.STORAGE_MODE = os.getenv("STORAGE_MODE", "cloud")
        ...
        self.MILVUS_LOCAL_DB_PATH = os.getenv("MILVUS_LOCAL_DB_PATH", "")
