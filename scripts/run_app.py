...
from urasys.core.retriever import DocumentRetriever, FAQRetriever
from urasys.core.retriever.base_class import DocumentRetrievalResult, FAQRetrievalResult
...
async def startup_event():
    ...
    try:
        ...
        config_path = Path(__file__).parent.parent / "src/urasys/config/models_config.json"
...
def init_document_bm25() -> bool:
    ...
    try:
        bm25_path = Path(__file__).parent.parent / "src/urasys/data/bm25/document/state_dict.json"
...
def init_faq_bm25() -> bool:
    ...
    try:
        bm25_path = Path(__file__).parent.parent / "src/urasys/data/bm25/faq/state_dict.json"
        if not bm25_path.exists():
...
async def index_documents(
    ...
    try:
        ...
        bm25_dir = Path(__file__).parent.parent / "src/urasys/data/bm25/document"
...
async def index_faq(
    ...
    try:
        ...
        bm25_dir = Path(__file__).parent.parent / "src/urasys/data/bm25/faq"
        bm25_dir.mkdir(parents=True, exist_ok=True)
